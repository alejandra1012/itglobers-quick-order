# Quick Order Component-custom

Componente QuickOrder, cuya funcion es realizar una orden rapida ingresando el número de SKU de un producto.

<div align="center">

<img height="400" src="assets/img/quick-order.png"/>
